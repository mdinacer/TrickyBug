        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_Photo_PhotoId",
                        column: x => x.PhotoId,
                        principalTable: "Photo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedMemberUserId = table.Column<string>(type: "TEXT", nullable: true),
                    AssignedMemberProjectId = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_ProjectMembers_AssignedMemberUserId_AssignedMemberProjectId",
                        columns: x => new { x.AssignedMemberUserId, x.AssignedMemberProjectId },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Descriptions_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Descriptions_PhotoId",
                table: "Descriptions",
                column: "PhotoId");

            migrationBuilder.CreateIndex(
                name: "IX_Descriptions_TicketId",
                table: "Descriptions",
                column: "TicketId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_AssignedMemberUserId_AssignedMemberProjectId",
                table: "Tickets",
                columns: new[] { "AssignedMemberUserId", "AssignedMemberProjectId" });
