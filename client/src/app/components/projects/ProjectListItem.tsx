...
export default function ProjectListItem({ project }: Props) {
  return (
    <Link to={`/projects/${project.slug}`}>
      <div className="relative w-full h-auto border-b-black hover:border-b-transparent hover:bg-slate-200 drop-shadow-sm lg:hover:drop-shadow-xl duration-700 transition-all lg:hover:-translate-y-3 rounded-md overflow-hidden flex flex-col">
