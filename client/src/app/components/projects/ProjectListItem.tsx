...
export default function ProjectListItem({ project }: Props) {
  return (
    ...
    // <Link to={`/projects/${project.slug}`}>
    //   <div className="relative w-full h-auto border-b-black hover:border-b-transparent bg-white lg:bg-transparent  lg:hover:bg-white drop-shadow-sm lg:hover:drop-shadow-xl duration-700 transition-all lg:hover:-translate-y-3 lg:rounded-md overflow-hidden flex flex-col">
    //     <div className="relative w-full h-64 lg:h-64 flex-initial">
    //       <img
    //         src={project.photo}
    //         className="object-fill object-center h-full w-full drop-shadow-md"
